...
namespace techrel
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            //int n1 = 4, n2 = 5, n3 = 6, n4=3;
            //int result = MathHelper.Findmax(n1, n2, n3);
            //Console.WriteLine($"max number in {n1},{n2} and {n3} is {result}");



            //int res = MathHelper.GetAddition(n1, n2);
            //Console.WriteLine($"Addition is=>{n1}+{n2}=={res}");
            //var res1= MathHelper.GetAddition(n3, n4);
            //res = MathHelper.GetAddition(res, res1);
            //Console.WriteLine($"Final Addition is => {res}");
